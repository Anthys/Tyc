...
function check_input()
  if m.r and game.nc then for i=0,15 do negate(i) end game.n=not game.n game.nc=false cam.x = 0 end
...
function update_camera()
  ...
  for x=prx//8-cam.lx//8//2,prx//8+cam.lx//8//2 do
    ...
    --for a,y in pairs({pry//8-cam.ly//8//2, pry//8+cam.ly//8//2}) do
      if block_cam(x, y) then cam.x,cam.y = lerp(cam.x,p.x-120, 0.05), cam.y clean = true break end
    end
  end
  --for y=pry//8-cam.ly//8//2,pry//8+cam.ly//8//2 do
